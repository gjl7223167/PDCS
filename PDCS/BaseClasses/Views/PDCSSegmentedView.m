...
@implementation PDCSSegmentedView
...
- (void)setSubViewWithTitles:(NSArray *)titles {
    ...
    for (int i = 0; i < titleNumber; i ++) {
        ...
        UILabel *titleLabel = [self labelWithFrame:CGRectMake(i * (labelWidht), 0, labelWidht, labelHeight) text:titles[i] textColor:kBarBgColor];
